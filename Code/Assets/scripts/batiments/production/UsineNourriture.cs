...
public class UsineNourriture: MonoBehaviour
{
	public static int travailleursVoulus = 20;
	public Vector2Int emplacement {get; set;}
	
	private bool enConstruction = true;
	private const int tailleX = 4;
	...
	public void placer ()
	{
		...
		Economie. habitantsNourriture += nouveauxTravailleurs;
